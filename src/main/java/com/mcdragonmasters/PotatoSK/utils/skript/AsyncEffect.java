 ...
 */
package com.mcdragonmasters.PotatoSK.utils.skript;
...
public abstract class AsyncEffect extends Effect {
    ...
    private boolean isDefaultAsync = PotatoSK.config.getBoolean("is_default_async");
    ...
    protected TriggerItem walk(Event e) {
        ...
        if (isAsync) {
            ...
            Bukkit.getScheduler().runTaskAsynchronously(PotatoSK.instance, () -> {
                ...
                if (getNext() != null) {
                    Bukkit.getScheduler().runTask(PotatoSK.instance, () -> { // Walk to next item synchronously
                        Object timing = null;
